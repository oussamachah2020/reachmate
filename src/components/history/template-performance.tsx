        ...
        <div className="space-y-4">
          {templates.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Create templates to see performance insights</p>
            </div>
          ) : (
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        <h3 className="font-semibold text-gray-900">{template.subject}</h3>
                        {template.trend === "up" && <TrendingUp className="h-4 w-4 text-green-600" />}
                        {template.trend === "down" && <TrendingDown className="h-4 w-4 text-red-600" />}
                        {template.category && (
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-3 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-semibold">{template.totalSent}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Open Rate:</span>
                      <span className="ml-2 font-semibold text-green-600">{template.openRate}%</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Reply Rate:</span>
                      <span className="ml-2 font-semibold text-blue-600">{template.replyRate}%</span>
                    </div>
                  </div>
                </div>
